...
print(element_caset.text)
print(element_title.text)
print(element_basePrice.text)
print(element_totalPrice.text)
...
#xpathで取得するとループできない
#xpath = '/html/body/div[1]/div[3]/div[2]/div[3]/div[2]/div[2]/div[1]/div/div[2]/h3/a'
